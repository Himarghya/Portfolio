...
export const MagneticButton: React.FC<MagneticButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      'bg-gradient-to-r from-[#00FF87] to-[#10B981] text-[#020704] font-bold hover:shadow-[0_0_25px_rgba(0,255,135,0.5)] border border-[#00FF87]/40',
    secondary:
      'bg-[#040E08]/80 text-[#00FF87] hover:bg-[#00FF87]/15 hover:text-white border border-[#00FF87]/30 hover:border-[#00FF87]/70 hover:shadow-[0_0_20px_rgba(0,255,135,0.25)]',
    outline:
      'bg-transparent text-slate-200 hover:text-[#00FF87] border border-emerald-900/60 hover:border-[#00FF87]/50 hover:bg-[#00FF87]/5',
    ghost:
