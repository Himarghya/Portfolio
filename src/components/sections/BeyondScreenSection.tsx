    ...
    <section id="beyond" className="relative py-24 border-t border-slate-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <HudBadge label="SECTION // 01" variant="emerald" pulse={false} />
              <span className="text-xs font-mono text-[#00FF87] uppercase tracking-widest">// 3D SPATIAL LAB</span>
            </div>
            <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-white">
              BEYOND THE <span className="text-glow-emerald text-[#00FF87]">SCREEN</span>
            </h2>
          ...
          <div className="glass-panel px-4 py-3 rounded-xl border border-emerald-950 flex flex-wrap items-center gap-4 text-xs font-mono text-slate-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="glass-panel p-4 rounded-xl border border-emerald-950">
            <div className="font-mono text-xs text-[#00FF87] mb-1">01 // ARCHITECTURAL TOPOLOGY</div>
          ...
          <div className="glass-panel p-4 rounded-xl border border-emerald-950">
            <div className="font-mono text-xs text-[#A3FF12] mb-1">02 // ALGORITHMIC RIGOR</div>
            <p className="text-xs text-slate-400">High efficiency C++ algorithmic patterns with robust time and memory bounds.</p>
          </div>
          <div className="glass-panel p-4 rounded-xl border border-emerald-950">
            <div className="font-mono text-xs text-[#6EE7B7] mb-1">03 // IMMERSIVE EXPERIENCES</div>
