...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#03050A] border-t border-slate-900 py-12 text-slate-400 font-mono text-xs overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center pb-8 border-b border-slate-900">
          ...
          <div className="md:col-span-6 space-y-2">
            <div className="flex items-center gap-2 text-white font-bold text-base">
              <span className="text-[#00E5FF]">HD //</span>
          ...
          <div className="md:col-span-6 flex flex-wrap items-center justify-start md:justify-end gap-4">
            <a
              ...
              className="p-2.5 rounded-lg bg-slate-900/80 border border-slate-800 text-slate-300 hover:text-[#00E5FF] hover:border-[#00E5FF]/40 transition-colors"
              title="GitHub"
            >
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-2 px-3.5 py-2 rounded-lg bg-[#0B1120] border border-slate-800 text-slate-300 hover:text-[#00E5FF] hover:border-[#00E5FF]/40 transition-all ml-2"
            >
              <span>TOP</span>
