  ...
  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-16 flex items-center justify-center overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              <HudBadge label={PERSONAL_INFO.status} variant="cyan" pulse={true} />
              <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-slate-800 bg-slate-900/40 text-[11px] font-mono text-slate-400">
            ...
            <div className="space-y-1">
              <span className="font-mono text-xs text-[#00E5FF] tracking-widest uppercase block">
              ...
              <h1 className="text-4xl sm:text-6xl xl:text-7xl font-bold tracking-tight text-white leading-[1.08]">
                BUILDING THE <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00E5FF] via-[#38BDF8] to-[#7C3AED]">
                  DIGITAL FUTURE.
                </span>
              </h1>
            </div>
            ...
            <div className="space-y-4 max-w-2xl">
              ...
              <div className="flex items-center gap-2 text-sm sm:text-base font-mono text-slate-400 bg-[#0B1120]/70 border border-[#00E5FF]/20 rounded-lg px-4 py-2.5 backdrop-blur-md">
            ...
            {/* Quick Metrics HUD */}
            <div className="pt-4 grid grid-cols-2 sm:grid-cols-4 gap-3 w-full border-t border-slate-800/80">
              {PERSONAL_INFO.stats.map((stat, idx) => (
                <div key={idx} className="glass-panel p-3 rounded-lg border border-slate-800 hover:border-[#00E5FF]/30 transition-colors">
                  <div className="font-mono text-lg font-bold text-white">{stat.value}</div>
                  <div className="text-[11px] font-mono text-[#00E5FF]">{stat.label}</div>
                  <div className="text-[10px] text-slate-500 truncate">{stat.detail}</div>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 sm:-bottom-4 right-0 sm:right-4 glass-panel p-3.5 rounded-xl border border-[#00E5FF]/40 bg-[#0B1120]/90 backdrop-blur-xl shadow-2xl max-w-[260px] pointer-events-none"
            >
              ...
              <div className="mt-2 pt-2 border-t border-slate-800 flex items-center justify-between text-[9px] font-mono text-[#00E5FF]">
                <span>CORE: v2.4</span>
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 opacity-60 hover:opacity-100 transition-opacity">
        <span className="text-[10px] font-mono tracking-widest text-[#00E5FF] uppercase">SCROLL // EXPLORE</span>
        <div className="w-4 h-7 rounded-full border border-[#00E5FF]/40 flex items-start justify-center p-1">
