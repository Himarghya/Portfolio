    ...
    <div id="timeline" className="relative py-12 px-4 sm:px-12 select-none border-t border-white/10">
      ...
      <div className="space-y-3">
        {currentSeason.episodes.map((ep) => (
          <div
            key={ep.epNumber}
            className="p-4 sm:p-5 rounded-xl bg-gradient-to-r from-white/[0.07] via-white/[0.03] to-white/[0.01] backdrop-blur-2xl border border-white/10 hover:border-[#E50914]/50 shadow-[0_8px_25px_rgba(0,0,0,0.3),inset_0_1px_1px_rgba(255,255,255,0.1)] hover:shadow-[0_12px_35px_rgba(229,9,20,0.18),inset_0_1px_1px_rgba(255,255,255,0.18)] transition-all duration-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 group hover:-translate-y-0.5"
          >
            ...
            <div className="flex items-start sm:items-center gap-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-white/[0.06] backdrop-blur-md text-zinc-300 border border-white/10">
                    {ep.duration}
                  </span>
                </div>
            ...
            <div className="text-xs font-mono text-zinc-400 sm:text-right shrink-0">
              <span className="text-[10px] text-zinc-400 block uppercase font-semibold">STACK</span>
              <span className="text-zinc-200 font-medium px-2 py-0.5 rounded bg-white/[0.04] border border-white/[0.08] inline-block mt-0.5">
                {ep.tech}
              </span>
            </div>
          </div>
