  ...
  return (
    <group>
      ...
      <mesh ref={radarRef} rotation={[Math.PI / 4, 0, 0]}>
        ...
        <meshBasicMaterial color="#00FF87" side={THREE.DoubleSide} transparent opacity={0.6} />
      </mesh>
  ...
  return (
    <div className="relative w-full h-[280px] sm:h-[320px] rounded-xl overflow-hidden bg-[#020704] border border-[#00FF87]/20 flex items-center justify-center">
      ...
      >
        ...
        <directionalLight position={[4, 5, 3]} intensity={1.5} color="#00FF87" />
        <pointLight position={[-4, -3, -3]} intensity={1} color="#10B981" />
        <WeatherEarth />
