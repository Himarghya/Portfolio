...
const NODES: NodeData[] = [
  { id: 'n1', name: 'VarshaNet Core', role: 'Weather Big Data GIS', pos: [2.5, 0.8, 1.2], color: '#00E5FF', tech: 'PostGIS + FastAPI' },
  { id: 'n2', name: 'Ocean Telemetry', role: 'Marine Observation', pos: [-2.6, -0.6, 1.0], color: '#38BDF8', tech: 'Docker + Analytics' },
  { id: 'n3', name: 'C++ Systems Engine', role: 'Algorithms & Structures', pos: [1.2, -2.2, -1.0], color: '#A3FF12', tech: 'C++20 / STL / Graph' },
  { id: 'n4', name: 'AI / Neural Model', role: 'Computer Vision & ML', pos: [-1.4, 2.3, -0.8], color: '#EC4899', tech: 'PyTorch / Scikit' },
  { id: 'n5', name: 'Full-Stack React Hub', role: 'Interactive UIs', pos: [0.2, 2.7, 1.5], color: '#7C3AED', tech: 'React / TypeScript' },
];
    ...
    <group position={node.pos}>
      ...
      {(hovered || isSelected) && (
        <Html distanceFactor={10} position={[0, 0.5, 0]} center>
          <div className="glass-panel px-3 py-2 rounded-lg border border-[#00E5FF]/40 bg-[#0B1120]/90 text-left min-w-[150px] shadow-2xl pointer-events-none transform -translate-y-2">
            ...
            <div className="text-[9px] text-[#00E5FF] font-mono mt-1 pt-1 border-t border-slate-700/60">{node.tech}</div>
          </div>
        </Html>
      )}
    </group>
...
export const BeyondTheScreen3D: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[550px] lg:h-[700px] rounded-2xl overflow-hidden border border-[#00E5FF]/20 bg-[#05070D] shadow-[0_0_50px_rgba(0,0,0,0.8)]">
      {/* 3D Canvas */}
      <Canvas
      ...
      <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
        <div className="glass-panel px-3.5 py-1.5 rounded-lg border border-[#00E5FF]/30 text-xs font-mono text-[#00E5FF] flex items-center gap-2 pointer-events-auto">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          <button
            ...
            className="p-2 rounded-lg glass-panel border border-slate-700 hover:border-[#00E5FF]/50 text-slate-300 hover:text-[#00E5FF] transition-all"
      ...
      {selectedNode && (
        <div className="absolute bottom-4 left-4 right-4 sm:right-auto sm:max-w-md pointer-events-auto">
          <div className="glass-panel p-4 rounded-xl border border-[#00E5FF]/30 bg-[#0B1120]/90 backdrop-blur-xl shadow-2xl">
            <div className="flex items-center justify-between gap-4 mb-2">
              ...
              <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-white/5 border border-slate-700 text-slate-300">
                ACTIVE_NODE
              </span>
            </div>
            <p className="text-xs text-slate-300 font-mono mb-2">{selectedNode.role}</p>
            <div className="flex items-center justify-between pt-2 border-t border-slate-800 text-[11px] font-mono text-[#00E5FF]">
