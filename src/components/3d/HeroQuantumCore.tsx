  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 pointer-events-none">
        <div className="glass-panel px-3 py-1.5 rounded-md border border-[#00E5FF]/20 text-[11px] font-mono text-[#00E5FF] flex items-center gap-2">
      ...
      <div className="absolute bottom-4 left-4 pointer-events-none">
        <div className="glass-panel px-3 py-1.5 rounded-md border border-slate-800 text-[10px] font-mono text-slate-400">
