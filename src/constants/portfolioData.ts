...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Cold-Chain Expedition Resource & Terrain Navigation",
    description: "An expedition resource and route optimization platform built for extreme Arctic environments, featuring full offline IndexedDB data synchronization and satellite telemetry uplink.",
    highlights: [
      "Offline-first PWA architecture with conflict-free IndexedDB replication",
      "Dynamic polar route pathfinding solver weighted by blizzard alerts",
      "Cargo manifest lifecycle tracking with QR token verification"
    ],
    techStack: ["React", "TypeScript", "FastAPI", "IndexedDB", "Leaflet", "Docker"],
    category: "Full Stack",
  ...
  },
  {
    id: "pulsemesh",
    number: "03",
    title: "PULSEMESH ORCHESTRATOR",
    subtitle: "Distributed Task Queue & Heartbeat Workflow Engine",
    description: "A distributed job orchestration system with atomic task leases, worker heartbeat tracking, exponential backoff retries, and real-time SSE telemetry streaming.",
    highlights: [
      "12,000 tasks/min load-tested throughput with zero task loss",
      "Automated 5-second worker failover watchdog and orphan task reassignment",
      "Real-time DAG visualization for multi-step task execution chains"
    ],
    techStack: ["Node.js", "Express", "Redis", "React", "SSE", "Tailwind CSS"],
  ...
  },
  {
    ...
    subtitle: "Smart Campus Operating System & Monorepo Portal",
    description: "A unified enterprise portal integrating course registration, role-based access management, attendance automation, and scheduling across student and faculty cohorts.",
    highlights: [
      "Granular JWT role-based access control with secure authentication",
      "Full-stack TypeScript monorepo with production build pipelines",
      "Relational schema indexing with PostgreSQL query caching"
    ],
    techStack: ["React", "Node.js", "Express", "TypeScript", "PostgreSQL", "Tailwind"],
    category: "Full Stack",
